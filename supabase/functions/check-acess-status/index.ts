...
//
// Chamada pelo frontend (usuário já logado) para confirmar que o código de
// acesso associado à sua conta continua ativo. Se o admin bloqueou o código
// depois do login, esta função é o que permite ao app detectar isso e
// encerrar a sessão automaticamente — sem depender do usuário clicar em
// "Sair da conta".
